...
use App\Models\PmbView\SvFormJualOnline;
use App\Models\User;
use Carbon\Carbon;
class SVPmbFormJuOnlineController extends SITUController
{
    /**
    ...
    {
       $this->_namaTabel = new SvFormJualOnline;
    ...
    public function createData(Request $request)
    {
        ...
        $this->validate($request,[
            'PMBFormJualOLID' => 'required|unique:sv_pmb_formulir_jual_online',
            // 'PMBPeriodID' => 'required|exists:sv_pmb_formulir_jual_online,PMBPeriodID',
            // 'PMBFormulirID' => 'required|exists:sv_pmb_formulir_jual_online,PMBFormulirID',
            // 'KodeID' => 'required|exists:sv_pmb_formulir_jual_online,KodeID',
            ...
            'ID' => 'required|numeric',
            'JenisVAID' => 'required',
            'NomorVA'=> 'required|numeric',
            'BayarID' => 'required',
            'PeriodeID' => 'required',
            'Tagihan' => 'required',
            'Bayar' => 'required',
            'WaktuInit' => 'required|date_format:Y-m-d H:i:s',
            'WaktuKadaluarsa' => 'required|date_format:Y-m-d H:i:s',
            'WaktuBayar' => 'required|date_format:Y-m-d H:i:s',
        ]);
        //data user pembuat
        $waktu = Carbon::now();
        ...
        $data = [
            ...
            'NA' => $request->input('NA'),
            'ID' => $request->input('ID'),
            'JenisVAID' => $request->input('JenisVAID'),
            'NomorVA'=> $request->input('NomorVA'),
            'BayarID' =>$request->input('BayarID'),
            'PeriodeID' => $request->input('PeriodeID'),
            'Tagihan' => $request->input('Tagihan'),
            'Bayar' => $request->input('Bayar'),
            'WaktuInit' => $request->input('WaktuInit'),
            'WaktuKadaluarsa' => $request->input('WaktuKadaluarsa'),
            'WaktuBayar' => $request->input('WaktuBayar'),
            //waktu
            'LoginBuat' => $userKode,
            'WaktuBuat' => $waktu
        ];
    ...
    {
        $namaTable = new SvFormJualOnline;
        $table = $namaTable->getTable();
        $kolom = 'PMBFormJualOLID';
        $this->$id=$id; 
