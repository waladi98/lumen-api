...
use App\Models\Pmb\SimakBesanPmbOnline;

class BesanPmbOnController extends SITUController
{
    /**
    ...
    {
       $this->_namaTabel = new SimakBesanPmbOnline;
       $this->_kolom = 'link_id';
    }
    ...
    public function createData(Request $request)
    {
        ...
        $this->validate($request,[
            ...
            'link_name' => 'required|unique:simak_besan_pmb_online|max:100',
