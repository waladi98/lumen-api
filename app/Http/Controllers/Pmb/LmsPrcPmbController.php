...
use App\Models\Pmb\LmsPrcPmb;

class LmsPrcPmbController extends SITUController
{
    /**
    ...
    public function createData(Request $request)
    {
        ...
        $this->validate($request,[
            'id' => 'required | numeric|unique:lms_prc_pmb|max:64',
            'proses' => 'required|String|in:Y,N',
            'nilai' => 'required|String|in:Y,N',
            //3 atribut
        ]);
        $data = [
            'id' => $request->input('id'),
